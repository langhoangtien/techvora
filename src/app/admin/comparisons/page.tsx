    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Quản lý trang so sánh sản phẩm, services và công cụ.
          </p>
        </div>
      ...
      <form className="grid gap-2 rounded-lg border bg-card p-4 md:grid-cols-4">
        <Input
          ...
          placeholder="Tìm title hoặc item"
        />
          ...
          },
          {
            ...
            cell: (row) => (
              <span className="text-muted-foreground">
                {row.itemAName} vs {row.itemBName}
              </span>
            ),
          },
          {
          ...
          },
          {
            ...
            cell: (row) => (
              <div className="flex justify-end gap-2">
                ...
                >
                  <Link
                    href={`/admin/comparisons/${row.id}/edit`}
                  >
                    <IconEdit />
                ...
                <DeleteComparisonButton id={row.id} />
              </div>
            ),
          },
        ]}
