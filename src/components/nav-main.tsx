    ...
    <SidebarGroup>
      ...
      <SidebarMenu>
        {items.map((item) => {
          ...
          const subItemActive = item.items?.some((subItem) => isActiveUrl(subItem.url)) ?? false
          const itemActive = item.isActive || isActiveUrl(item.url) || subItemActive
                ...
                <CollapsibleContent>
                  <SidebarMenuSub>
                    {item.items?.map((subItem) => {
                      const active = isActiveUrl(subItem.url)
