...
-- CreateEnum
CREATE TYPE "PostType" AS ENUM ('ARTICLE', 'TOOL', 'SAAS', 'COMPARISON', 'PAGE');
...
-- CreateIndex
CREATE INDEX "ServiceProduct_status_category_isFeatured_order_idx" ON "ServiceProduct"("status", "category", "isFeatured", "order");

-- CreateIndex
CREATE INDEX "ServiceProduct_rating_idx" ON "ServiceProduct"("rating");
